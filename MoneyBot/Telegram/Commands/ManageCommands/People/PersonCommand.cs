    ...
    public class PersonCommand : Command
    {
        ...
        public override Response Execute(Message message, Account account)
        {
            if (message.Text == "Add people")
            {
                ...
                return new Response(account, $"Enter new people in format:\n" +
            ...
            if (message.Text == "Show people")
            {
                ...
                else return new Response(account, $"You have no people.");
            }
            if (message.Text == "Override people")
            {
                account.Status = AccountStatus.OverridePeople;
                return new Response(account, "This will override your people and delete attached transactions.\nEnter new people in format:\n" +
                    "[alias] [name]", replyMarkup : Keyboards.Cancel);
            }
